...
local Window = Fluent:CreateWindow({
    Title = game:GetService("MarketplaceService"):GetProductInfo(16732694052).Name .." | Jafor HUB - Premium",
    SubTitle = " (discord.gg/niemajeszcze)", -- discord link
    TabWidth = 160,
...
local Tabs = { -- https://lucide.dev/icons/
    ...
    Aa = Window:AddTab({ Title = "Auto Appraise", Icon = "gift" })
}
...
do
    ...
    local TotemTPDropdownUI = Tabs.Teleports:AddDropdown("TotemTPDropdownUI", {
        Title = "Select Totem",
        Values = {"Aurora", "Sundial", "Windset", "Smokescreen", "Tempest", "Meteor", "Eclipse"},
        Multi = false,
        Default = nil,
    })
    TotemTPDropdownUI:OnChanged(function(Value)
        ...
        elseif SelectedTotem == "Meteor" then
            HumanoidRootPart.CFrame = CFrame.new(-1946, 277, 232)
            TotemTPDropdownUI:SetValue(nil)
        elseif SelectedTotem == "Eclipse" then
            HumanoidRootPart.CFrame = CFrame.new(5968, 273, 836)
            TotemTPDropdownUI:SetValue(nil)
        end
    end)
    ...
    local section = Tabs.Aa:AddSection("Auto Appraise")
    ...
    Tabs.Aa:AddInput("Input", {
        Title = "Weight",
        Description = "Input Weight value (0 = random)",
        Default = "",
        Placeholder = "",
        Numeric = true, -- Only allows numbers
        Finished = false, -- Only calls callback when you press enter
        Callback = function(Value)
            filterData.Weight = tonumber(Value)
        end
    })

    Tabs.Aa:AddToggle("MyToggle", {
        Title = "Sparkling", 
        Default = false,
        Callback = function(state)
            filterData.Sparkling = state
        end
    })
    ...
    Tabs.Aa:AddToggle("MyToggle", 
    {
        ...
        Default = false,
        Callback = function(state)
            filterData.Shiny = state
        end
    })

    Tabs.Aa:AddInput("Input", {
        Title = "Mutation",
        Description = "Input mutation name",
        Default = "",
        Placeholder = "",
    ...
    Tabs.Aa:AddSlider("Slider", 
    {
        Title = "Delay",
        Description = "Appraise delay",
        Default = 2,
        Min = 0.1,
        Max = 5,
        Rounding = 1,
    ...
    Tabs.Aa:AddToggle("MyToggle", 
    {
        ...
        Callback = function(Value)
            _G.aa1 = Value
            if _G.aa1 then
            local aa1 = CFrame.new(440, 150, 206)
            HumanoidRootPart.CFrame = aa1
            end
            _G.AA = Value
